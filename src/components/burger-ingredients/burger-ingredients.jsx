...
export default function BurgerIngredients(props) {
    ...
    const card = (item) => {
        ...
        return (
            ...
            <li key={item._id} id={item._id} className={styles.card} onClick={props.openModal}>
                {/* <Counter /> */}
    ...
    useEffect(() => {
        if (current === 'buns') {
            bunsScrollRef.current.scrollIntoView({ behavior: "smooth", block: 'start' });
        } else if (current === 'sauces') {
            saucesScrollRef.current.scrollIntoView({ behavior: "smooth", block: 'start' });
        } else if (current === 'mains') {
            mainsScrollRef.current.scrollIntoView({ behavior: "smooth", block: 'start' });
        }
    }, [current]);
        ...
        <div className={styles.burger_ingredients}>
            <div className={styles.button_container}>
                <ul className={styles.button_list}>
                    <li className={styles.button_item}><Tab value="buns" active={current === 'buns'} onClick={setCurrent}>Булки</Tab></li>
                    <li className={styles.button_item}><Tab value="sauces" active={current === 'sauces'} onClick={setCurrent}>Соусы</Tab></li>
                    <li className={styles.button_item}><Tab value="mains" active={current === 'mains'} onClick={setCurrent}>Начинки</Tab></li>
                </ul>
            </div>
